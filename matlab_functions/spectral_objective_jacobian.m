function f = spectral_objective_jacobian( q, v )
  %{
  PURPOSE:
  Supposing one has converged a RPO in the form of q, find an eigenvector v
  of the linearized flow. By this, we mean a periodic vector v(t) such that
  dv/dt = J*v - \lambda *v, where \lambda is the eigenvalue of the flow (or
  its natural log if you think of the Monodromy matrix)
  ...
  v - a 6*N+1 vector
     ...
     lam - eigenvalue
     Note this vector v can be complex.
